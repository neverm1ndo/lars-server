...
export class Watcher {
  ...
  getLogFIle() {
    const date = new Date();
    const logpath = path.join(process.env.LOGS_PATH!, this.convert(date.getMonth() + 1), date.getFullYear()+this.convert(date.getMonth()+1)+this.convert(date.getDate())+'.log')
